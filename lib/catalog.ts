...
export const CATALOG: CatalogBrand[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { id: 'nectar-classic-hybrid', name: 'Classic Hybrid', brand: 'nectar', url: 'https://www.nectarsleep.com/mattresses/hybrid-mattress', apiProductName: 'nectar-51-classic-hybrid-mattress' },
      { id: 'nectar-premier-foam', name: 'Premier Memory Foam', brand: 'nectar', url: 'https://www.nectarsleep.com/mattresses/premier-memory-foam-mattress', apiProductName: 'nectar-51-premier-foam-mattress' },
      { id: 'nectar-premier-hybrid', name: 'Premier Hybrid', brand: 'nectar', url: 'https://www.nectarsleep.com/mattresses/premier-hybrid-mattress', apiProductName: 'nectar-51-premier-hybrid-mattress' },
      { id: 'nectar-luxe-foam', name: 'Luxe Memory Foam', brand: 'nectar', url: 'https://www.nectarsleep.com/mattresses/luxe-memory-foam-mattress', apiProductName: 'nectar-51-luxe-foam-mattress' },
      { id: 'nectar-luxe-hybrid', name: 'Luxe Hybrid', brand: 'nectar', url: 'https://www.nectarsleep.com/mattresses/luxe-hybrid-mattress', apiProductName: 'nectar-51-luxe-hybrid-mattress' },
      { id: 'nectar-ultra-foam', name: 'Ultra Memory Foam', brand: 'nectar', url: 'https://www.nectarsleep.com/mattresses/ultra-memory-foam-mattress', apiProductName: 'nectar-50-ultra-foam-mattress' },
      { id: 'nectar-ultra-hybrid', name: 'Ultra Hybrid', brand: 'nectar', url: 'https://www.nectarsleep.com/mattresses/ultra-hybrid-mattress', apiProductName: 'nectar-50-ultra-hybrid-mattress' },
    ],
  },
  {
